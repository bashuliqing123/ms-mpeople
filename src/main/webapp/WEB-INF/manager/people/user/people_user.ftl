<@ms.html5>
	...
	<@ms.panel>
		<@ms.form isvalidation=true name="peopleForm" action="${managerPath}/people/user/${autoCURD}.do" redirect="${managerPath}/people/user/list.do?${params}">
			...
			<@ms.text name="peopleName" label="用户名" placeholder="请输入用户名"  title="" size="5" width="300"  value="${peopleUser.peopleName?default('')}" validation={"data-bv-stringlength":"true","data-bv-regexp":"true","data-bv-regexp-regexp":'^[^[!@#$%^&*()_+-/~?！@#￥%…&*（）——+—？》《：“‘’]+$',"data-bv-stringlength-max":"12","data-bv-regexp-message":"用户名长度不能超过12个字符且不能包含特殊字符"}/>
			...
			<@ms.text name="peopleUserRealName" label="姓名"  placeholder="请输入姓名" title="" value="${peopleUser.peopleUserRealName?default('')}" size="2" width="300" validation={"data-bv-stringlength":"true","data-bv-stringlength-max":"8","data-bv-regexp":"true","data-bv-regexp-regexp":'^[^[!@#$%^&*()_+-/~?！@#￥%…&*（）——+—？》《：“‘ ’]+$',"data-bv-regexp-message":"真实姓名长度不能超过8个字符且不能包含特殊字符"}/>
			...
			<@ms.text name="peopleUserCard" label="用户身份证" placeholder="请输入用户身份证" title="" size="5"  width="300" value="${peopleUser.peopleUserCard?default('')}"   validation={"data-bv-stringlength":"true","data-bv-stringlength-max":"18","data-bv-regexp":"true","data-bv-regexp-regexp":'^[X0-9]+$',"data-bv-regexp-message":"身份证输入不合法"}/>
