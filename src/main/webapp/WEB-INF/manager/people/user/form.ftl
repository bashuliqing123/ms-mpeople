    ...
    <@ms.panel>
    	<@ms.form name="peopleUserForm" isvalidation=true>
			...
			<@ms.formRow label="头像" width="400">
					<@ms.uploadImg path="people" uploadFloderPath="${peopleImagesUrl?default('')}" inputName="puIcon" size="1" filetype="" msg="提示:头像缩略图,支持jpg格式"  maxSize="2" imgs="${(peopleUserEntity.puIcon)?default('')}"  />
			</@ms.formRow>
